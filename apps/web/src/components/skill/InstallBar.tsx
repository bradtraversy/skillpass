...
export default function InstallBar({ slug, version }: { slug: string; version: string }) {
		...
		<>
			<div className="flex items-center gap-3 rounded-md border border-border bg-surface p-[14px]">
				...
				<button
					...
					className="inline-flex cursor-pointer items-center gap-[7px] rounded-sm bg-accent px-[15px] py-[9px] text-[13px] font-semibold text-accent-ink hover:bg-accent-hover"
				>
					<svg
						width="15"
						height="15"
